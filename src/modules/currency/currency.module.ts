...
import { TARGET_CURRENCY_PREFERENCE_PORT } from "./application/ports/target-currency-preference.port";
...
@Module({
  ...
  providers: [
    ...
    {
      provide: TARGET_CURRENCY_PREFERENCE_PORT,
      useClass: InMemoryTargetCurrencyPreferenceAdapter,
    },
